...
// Backup system
router.get('/backup/download', authenticate, settingController.downloadZipBackup);
router.get('/backup/list', authenticate, settingController.listBackups);
router.post('/backup/create-now', authenticate, settingController.createBackupNow);
router.post('/backup/restore-zip', authenticate, settingController.restoreZipBackup);
